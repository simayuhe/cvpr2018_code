...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	string T = { "D:/code/TEMP/GVEII/data/data2400frames/test.mat" };
	//string save_dir{ "D:/code/mycode/HDDCRP_V3/synthetic/outputdata/synthetic_dat_tt_V1_1/" };
	string save_dir{ "D:/code/TEMP/GVEII/result/exper2401/" };
	_mkdir("D:/code/TEMP/GVEII/result/exper2401/");
	//*************************//
