...
Student101="./HddCRPtxt -data ../data/data5000frames/ -link ../data/data5000frames/ -K 300 -alpha0 1e-5 -alpha1 1e-30 -num_burn_in 10 -num_samples 100 -num_space 10 -save_dir ../result/exper101/ "

GVEII101="./HddCRPtxt -data ../data/data2400frames/ -link ../data/data2400frames/ -K 1000 -alpha0 1e-3 -alpha1 1e-10 -num_burn_in 10 -num_samples 100 -num_space 10 -save_dir ../result/exper101/ "
