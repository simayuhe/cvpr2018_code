...
#ifdef TRI_MULT_DIST
	HH hh(size_voc_word, eta_i_word, size_voc_source, eta_i_source, size_voc_sink, eta_i_sink);
#else
...
cout<<"link_file_name"<<link_file_name<<endl;
	model.load_txt_link(link_file_name);
cout<<"link load well"<<endl;

#ifdef TRI_MULT_DIST
cout<<"initss_file_name"<<initss_file_name<<endl;
	model.load_txt_initss(initss_file_name);
cout<<"initss_file load well"<<endl;
#endif
