function inds_sub_tjcs = divide_tjcs(save_dir,tjc_pro,len_tjc,do_plot,flag,varargin)
narginchk(6,6);
...
save([save_dir 'num_sub_tjc.mat'], 'num_sub_tjc');
