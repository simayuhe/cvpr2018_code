function [ avg, covariance ] = error_elipse( data , confidence_interval)
%ERROR_ELIPSE 此处显示有关此函数的摘要
%   此处显示详细说明clear all;
...
%类似地，99％的置信区间对应为s=9.210，90％置信区间对应于s=4.605。要开根号
if confidence_interval==0.99
    chisquare_val = 3.02;%95%
end
...
if confidence_interval==0.90
    chisquare_val = 2.1460;%90%
end
if confidence_interval==0.80
    chisquare_val = 1.8;%90%
end
if confidence_interval==0.70
    chisquare_val = 1.5;%90%
end
if confidence_interval==0.5
    chisquare_val =0.5;
end
if confidence_interval ==0.4
    chisquare_val =0.4;
end
...
plot(r_ellipse(:,1) + X0,r_ellipse(:,2) + Y0,'y-','Linewidth',6)
hold on;
% 
